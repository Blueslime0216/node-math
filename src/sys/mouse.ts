...
export class Mouse {
    private _mousePos: TPoint = new Point(-1, -1); // 마우스 위치 (초기값은 -1, -1로 설정)
    ...
    // 마우스 클릭 상태 여부
    private _isMouseClick: IMouseKeys = { left: false, wheel: false, right: false };
    // 마우스 드래그 시작 상태 여부
    private _isMouseDragFirst: IMouseKeys = { left: false, wheel: false, right: false };
    // 마우스 드래그 상태 여부
    ...
    get mousePos(): TPoint { return this._mousePos; } // 마우스 위치 반환
    // get mousePos_offset(): TPoint { return this._mousePos_offset; } // 마우스 상대 위치 반환
    get isMouseDown(): IMouseKeys { return this._isMouseDown; } // 마우스가 눌려있는지 여부 반환
    // isMouseDown.left, isMouseDown.wheel, isMouseDown.right로 사용
    get mouseStart(): IMouseKeysPoint { return this._mouseStart; } // 마우스 클릭 시작 지점 반환
    get isMouseClick(): IMouseKeys { return this._isMouseClick; }
    get isMouseDragFirst(): IMouseKeys { return this._isMouseDragFirst; }
    get isMouseDragging(): IMouseKeys { return this._isMouseDragging; } // 현재 드래그 중인지 여부 반환
    get draggedSize(): IMouseDraggedSize { return this._draggedSize; } // 드래그 중인 크기 반환
    get wheelDelta(): IWheelDelta { return this._wheelDelta; } // 휠 방향 반환

    set mousePos(value: TPoint) { this._mousePos = value; }
    ...
    set isMouseClick(value: IMouseKeys) { this._isMouseClick = value; }
    set isMouseDragFirst(value: IMouseKeys) { this._isMouseDragFirst = value; }
